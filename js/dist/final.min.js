...
$(function () {
	...
	$('#defaultCountdown').countdown({until: new Date(2015, 11, 20)});
$('#year').text(2015);
});

$('#close-video-cases').click(function() {
   pilotoVimeo = $('#piloto-vimeo');
   pilotoVimeo.html( pilotoVimeo.html() );
});
